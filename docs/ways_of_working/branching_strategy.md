...
This document outlines the standard workflow for feature development, testing, and deployment using GitHub branches. It is the canonical version shared across all AIKYA repositories — `aikya-agent-factory`, `aikya-platform`, `marsCLI`, `mars-standard`, `AIKYA-KG`, and `aikya.bio-website`.
